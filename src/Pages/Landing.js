...
function Landing() {
  return (
    <div className="h-screen">
      <div className="w-full h-1/3 sm:h-1/2 pt-64 bg-[#05998C] flex flex-col justify-center items-center">
        <img
          src={logo}
      ...
      <div className="flex flex-col justify-center items-center w-full h-2/3 bg-white bg-[url('/src/assets/bills.png')] bg-cover opacity-30 ">
